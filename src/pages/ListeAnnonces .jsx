...
const ListeAnnonces = () => {
  ...
  // Filtrer les annonces pour ne garder que celles qui appartiennent à l'utilisateur actuel
  const userAnnonces = announcements.filter(announcement => user && user.id === announcement.user_id);

  return (
    <div id="mesannonces" className="mt-8 bg-white rounded-lg shadow-md p-6 animate-slideIn">
      <h2 className="text-2xl font-bold mb-4">Vos annonces récentes</h2>
              ...
              <tr key={announcement.id} className="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td className="py-3 px-6 text-center">
                  <div className="flex item-center justify-center">
                    <Link to={`/edit-annonce/${announcement.id}`} className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
